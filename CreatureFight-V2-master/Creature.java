...
public class Creature extends Actor
{
    ...
    /**
     * The Attack method puts a comment stating that attack is an empty method that will get overridden in subclasses.
     * 
     * @param There is a integer called idx 
     * @return Nothing is returned
     */
     ...
     */
    /**
     * The getType method, returns the type of the Creature using the type integer
     * 
     * @param There are no parameters
