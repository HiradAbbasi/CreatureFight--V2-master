...
public class Charmander extends Creature
{
     ...
     * 
     *      TODO (60): The user has chosen Scratch, so add -25 points of health to the enemy's health bar (you will need to use the add method of 
     *      health bar and use the getHealthBar method of enemy to do this)
     *      
     * TODO (61): Otherwise...
     * 
    ...
    /**
     * The attack method has a varrible called playerWorld that stores a reference to the CreatureWorld. It also stores a variable called enemy
     * that is initialized to player two's creature. The third varriable is called called enemyType that is initialized to the enemy's type.
     * If the idx parameter is equal to 0 the f method will add -25 points of health to the enemy's health bar and if not is will add -70
     * points to the health of the enemy's health bar.
     * 
     * @param There is one integer inside the oarameters called idx 
